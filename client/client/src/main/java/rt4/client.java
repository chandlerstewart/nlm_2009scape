...
import python.AutoLogin;
import python.Python;
import python.PythonSocket;
...
public final class client extends GameShell {
	...
	//public static python.Python Python;
				...
				try {
					...
					for (local84 = 0; local84 < InterfaceList.rectangles; local84++) {
						if (InterfaceList.rectangleRedraw[local84]) {
							...
							//Image image = SoftwareRaster.frameBuffer.image;
						}
					}
	...
	private void sendImagePython(){

		try {
			Image image = SoftwareRaster.frameBuffer.image;
			BufferedImage bufferedImage = new BufferedImage(SoftwareRaster.frameBuffer.width, SoftwareRaster.frameBuffer.height, BufferedImage.TYPE_INT_RGB);
			bufferedImage.getGraphics().drawImage(image, 0, 0, null);
			ImageIO.write(bufferedImage,"png", new File("C:\\2009scape-master\\client\\images\\testimage.png"));
		} catch (Exception e){
